    ...
    pub fn from_special_transaction_outcome(
        ...
        match outcome {
            SpecialTransactionOutcome::BakingRewards {
                ...
                rewards: baker_rewards.into_iter().map(|reward| reward.into()).collect(),
            })),
            ...
            SpecialTransactionOutcome::FinalizationRewards {
                ...
                remainder,
            } => Ok(Self::FinalizationRewardsSpecialEvent(FinalizationRewardsSpecialEvent {
                id,
                rewards: finalization_rewards.into_iter().map(|reward| reward.into()).collect(),
                remainder: remainder.into(),
            })),
            ...
            SpecialTransactionOutcome::PaydayFoundationReward {
                foundation_account,
                development_charge,
            } => Ok(Self::PaydayFoundationRewardSpecialEvent(PaydayFoundationRewardSpecialEvent {
                id,
            ...
            SpecialTransactionOutcome::PaydayAccountReward {
                ...
                baker_reward,
                finalization_reward,
            } => Ok(Self::PaydayAccountRewardSpecialEvent(PaydayAccountRewardSpecialEvent {
                id,
            ...
            SpecialTransactionOutcome::BlockAccrueReward {
                ...
                foundation_charge,
                baker_id,
            } => Ok(Self::BlockAccrueRewardSpecialEvent(BlockAccrueRewardSpecialEvent {
                transaction_fees: transaction_fees.into(),
                old_gas_account: old_gas_account.into(),
                new_gas_account: new_gas_account.into(),
                baker_reward: baker_reward.into(),
            ...
            SpecialTransactionOutcome::PaydayPoolReward {
                ...
                Ok(Self::PaydayPoolRewardSpecialEvent(PaydayPoolRewardSpecialEvent {
                    pool,
                    transaction_fees: transaction_fees.into(),
                    baker_reward: baker_reward.into(),
                    finalization_reward: finalization_reward.into(),
            ...
            SpecialTransactionOutcome::ValidatorPrimedForSuspension {
                baker_id,
                account,
            } => Ok(Self::ValidatorPrimedForSuspension(ValidatorPrimedForSuspension {
                baker_id: baker_id.try_into()?,
                account:  account.into(),
            })),
        }
...
impl FinalizationRewardsSpecialEvent {
    async fn id(&self) -> &types::ID { &self.id }

    async fn remainder(&self) -> Amount { self.remainder }
...
impl From<&concordium_rust_sdk::types::SpecialTransactionOutcome> for SpecialEventTypeFilter {
    fn from(value: &concordium_rust_sdk::types::SpecialTransactionOutcome) -> Self {
        ...
        match value {
            ...
            O::FinalizationRewards {
                ..
            } => Self::FinalizationRewards,
            O::BlockReward {
                ..
            } => Self::BlockRewards,
            O::PaydayFoundationReward {
                ..
            } => Self::PaydayFoundationReward,
            O::PaydayAccountReward {
                ..
            } => Self::PaydayAccountReward,
            O::BlockAccrueReward {
                ..
            } => Self::BlockAccrueReward,
            O::PaydayPoolReward {
                ..
            } => Self::PaydayPoolReward,
            O::ValidatorSuspended {
                ..
            } => Self::ValidatorSuspended,
            O::ValidatorPrimedForSuspension {
                ..
