-- This index was added in migration file 0001, but due to a later migration script (0037) - dropping of the column 'type_account' inherently causes the index to also drop. Then the column was re-added so now the index needs to be re-added
