    ...
    fn from(payload: UpdatePayload) -> Self {
        match payload {
            ...
            UpdatePayload::Level1(_) => {
                ChainUpdatePayload::Level1Keys(Level1KeysChainUpdatePayload { dummy: true })
            }
            ...
            UpdatePayload::Root(_) => {
                ChainUpdatePayload::RootKeys(RootKeysChainUpdatePayload { dummy: true })
            }
