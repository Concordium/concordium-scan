...
public sealed class InitialContractRejectEventDeserializationEventFieldsCatchUpJob : IStatelessJob
{
    /// <summary>
    ...
    public InitialContractRejectEventDeserializationEventFieldsCatchUpJob(
