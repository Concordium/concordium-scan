...
public class PaydayAccountRewardSpecialEvent : SpecialEvent
{
    ...
    {
        yield return new(Account, (long)TransactionFees.Value, BalanceUpdateType.TransactionFeeReward);
        yield return new(Account, (long)BakerReward.Value, BalanceUpdateType.BakerReward);
        yield return new(Account, (long)FinalizationReward.Value, BalanceUpdateType.FinalizationReward);
    }
}