...
public class GraphQlDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        chainParametersBuilder.HasKey(x => x.Id);
        chainParametersBuilder.Property(x => x.Id).HasColumnName("id").ValueGeneratedOnAdd();
        chainParametersBuilder.Property(x => x.ElectionDifficulty).HasColumnName("election_difficulty");
        chainParametersBuilder.OwnsOne(cp => cp.EuroPerEnergy, euroPerEnergyBuilder =>
        {
        ...
        chainParametersBuilder.OwnsOne(cp => cp.MicroCcdPerEuro, microCcdPerEnergyBuilder =>
        {
        ...
        chainParametersBuilder.Property(x => x.BakerCooldownEpochs).HasColumnName("baker_cooldown_epochs");
        chainParametersBuilder.Property(x => x.CredentialsPerBlockLimit).HasColumnName("credentials_per_block_limit");
        chainParametersBuilder.OwnsOne(cp => cp.RewardParameters, rewardParametersBuilder =>
        {
        ...
        blockBuilder.Property(x => x.ChainParametersId).HasColumnName("chain_parameters_id");
