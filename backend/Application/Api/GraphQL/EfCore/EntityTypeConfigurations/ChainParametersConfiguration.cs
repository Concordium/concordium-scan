...
public class ChainParametersConfiguration : IEntityTypeConfiguration<ChainParameters>,
    ...
    IEntityTypeConfiguration<ChainParametersV2>,
    IEntityTypeConfiguration<ChainParametersV3>
{
    public void Configure(EntityTypeBuilder<ChainParameters> builder)
    {
        ...
        builder
            ...
            .HasValue<ChainParametersV2>(2)
            .HasValue<ChainParametersV3>(3)
            .IsComplete();
    }
    ...
    public void Configure(EntityTypeBuilder<ChainParametersV2> builder)
    {
        builder.OwnsOne(cp => cp.EuroPerEnergy, euroPerEnergyBuilder =>
        {
            euroPerEnergyBuilder.Property(x => x.Numerator).HasColumnName("euro_per_energy_numerator");
    ...
    public void Configure(EntityTypeBuilder<ChainParametersV3> builder)
    {
        builder.OwnsOne(cp => cp.EuroPerEnergy, euroPerEnergyBuilder =>
        {
            euroPerEnergyBuilder.Property(x => x.Numerator).HasColumnName("euro_per_energy_numerator");
